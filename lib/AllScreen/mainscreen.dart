...
import 'package:rider_app/AllScreen/profileTabPage.dart';
import 'package:rider_app/AllScreen/ratingScreen.dart';
import 'package:rider_app/AllScreen/registerationScreen.dart';
import 'package:rider_app/AllScreen/searchScreen.dart';
...
import 'package:rider_app/Assistants/assistantMethod.dart';
...
String? imageUrl = null;
  void uploadImage()async{
    ...
    if(image != null){
    var snapshot = await  _storage.ref().child('profile/image').putFile(file);
    var downloadUrl  =  await snapshot.ref.getDownloadURL();

    if (firebaseUser != null) //user created
        {
      //save pics info to database
      Map<String, dynamic> userDataMap = {
        "pics": downloadUrl

      };
      //
      usersRef.child(firebaseUser.uid).update(userDataMap);
            ...
            children: [
              ...
              Container(
                ...
                child: DrawerHeader(
                  ...
                  child: Row(
                    children: [
                      GestureDetector(child: (userCurrentInfo.pics != null) ?
                      Container(
                        ...
                        height: 65.0, width: 65.0,
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              //userCurrentInfo.pics!
                                image: NetworkImage(userCurrentInfo.pics!),
                                fit: BoxFit.fill
                            ),
                          ),
                              ...
                              children: [
                                Text(
                                  ...
                                  Provider.of<AppData>(context).pickUpLocation != null
                                      ...
                                      : "Add Home",  overflow: TextOverflow.visible,
                                  softWrap: false,
                                ),
                                SizedBox(height: 4.0,),
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null) ? NumberFormat.simpleCurrency(name: 'NGN').format((AssistantMethods.calculateFares(tripDirectionDetails))/2) : ''), style: TextStyle(fontFamily: "Brand Bold",),
                                ),
                              ],
                            ),
                          ),
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(child: Container()),
                                Text(
                                  ((tripDirectionDetails != null) ? NumberFormat.simpleCurrency(name: 'NGN').format(AssistantMethods.calculateFares(tripDirectionDetails)) : ''), style: TextStyle(fontFamily: "Brand Bold",),
                                ),
                              ],
                            ),
                          ),
  ...
  void initGeoFireListner()
  {
    ...
    //comment
    Geofire.queryAtLocation(currentPosition.latitude, currentPosition.longitude, 45)!.listen((map) {
      print(map);
      if (map != null) {
